...
// // let newArr =numbers.map((number,i,arr)=>{
// //     return number*2;
// // })
// // console.log('new Array',newArr);
...
// // ];
// // // 1
// // const filteredItems = totalArr.filter(item => item.rating.rate > 3);
// // // console.log(filteredItems);
// // // 2
// // const discountedPrices = filteredItems.map(item => ({
// //     ...item,
...
// // const totalPrice = totalArr.reduce((acc, product) => acc + product.price, 0);

// // // console.log("Ümumi Qiymət:", totalPrice.toFixed(2));

// // // 4
// // const categoryFiltered=filteredMen.filter(map=>([...totalArr])) ;
...
class MIlk extends Product {
  constructor(id,name,price,fatParsent,madeIn)

{
  super(id,name,price);
this.fatParsent = fatParsent;
this.madeIn = madeIn;
}
}
const süd1=new MIlk(1,"Milla",15, 2.3,"Zagatala");
const süd2=new MIlk(2,"Öz-Süt",10,3.5,"Guba");
const süd3=new MIlk(3,"Zalatoye",20,1.2,"Sumgait");

const milkArr=[süd1,süd2,süd3];
// console.log("Milks",milkArr);

// TASK 1.2 : Məhsullardan id-si 1-ə bərabər olan məhsulu qaytaran funksiya yazın.
function getProductById(id){
  return milkArr.find(product => product.id === id);
}
const productWithId1= getProductById(1);
const productWithId2= getProductById(2);
const productWithId3= getProductById(3);

// console.log(" Id Number 1 return",productWithId1);
// console.log(" Id Number 2 return",productWithId2);
// console.log(" Id Number 3 return",productWithId3);
...
function productfatParcent(arr){
let count = 0;
let avarage = 0;

arr.map((el) => {
  count++
  avarage+=el.fatParsent
...
function highFatMilk() {
 let filtered= milkArr.filter(süd => süd.fatParsent >3);
  return  filtered

}
// console.log("yagliligi 3den boyuk olanlar",highFatMilk());
